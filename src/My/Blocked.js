...
{  
  ...
  useEffect(()=>{
     axios.get("http://52.53.149.31:3306/nois").then(res=>setProducts(res.data));
 },[]);
 ...
 function Piya(e){
  ...
  axios.get(`http://52.53.149.31:3306/mino/${id}`).then(
    res => setProducts(res.data));
  
  axios.get(`http://52.53.149.31:3306/kika/${id}`).then(
      res => setProducts(res.data));
      navigate("/Users");
